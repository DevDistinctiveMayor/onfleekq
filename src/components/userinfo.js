          ...
          <div class="mt-6 flex gap-1">
            <div class="flex">
              <div class="flex gap-2">
                <div class="bg-violet-800 w-[1.7rem] h-[1.7rem] rounded-full ml-2">
            ...
            <div>
              <div class="flex gap-2">
                <div class=" bg-cyan-400 w-[1.7rem] h-[1.7rem] flex justify-center rounded-full ml-2">
                  <p style={iconStyle1}>L</p>
                </div>
