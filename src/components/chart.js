    ...
    <div>
      <div>
        <div className="lg:hidden flex justify-center mt-10 cursor-pointer">
          <div className="flex rounded-2xl shadow-slate-300 shadow-2xl">
            <div
              className="w-[5rem] py-3 flex justify-center hover:bg-cyan-400 rounded-2xl"
              onClick={handleShowClick}
            >
              <FaSignal
                class="text-slate-400 transition-colors duration-300 hover:text-white"
                style={iconStyle}
              />
            </div>
            <div
              className="w-[5rem] py-3 flex justify-center hover:bg-cyan-300 rounded-2xl "
        ...
        <div className="flex sm:gap-[2.5rem] gap-[1rem] mt-[2rem] ml-6">
          <div className="shadow-slate-300 shadow-xl lg:w-[13rem] w-[6.5rem] lg:h-[5rem] h-[9rem] rounded-[10px]">
            <div className="lg:flex gap-2 mt-2 lg:flex-row flex-col-reverse flex">
              <img
                src={chart1}
                className="w-[3.5rem] lg:w-[3rem] h-[4rem] lg:h-[2rem] lg:mt-4 ml-6 bg-slate-500"
              />
              <div className="text-sm ml-6 lg:ml-2 mt-2">
                <p className="text-[10px] text-slate-400 font-medium">
                  VISITORS
                </p>
                <p className="font-bold lg:text-black text-violet-700">
                  10,320
                </p>
              </div>
            </div>
          ...
          <div className="shadow-slate-300 shadow-xl lg:w-[13rem] w-[6.5rem] lg:h-[5rem] h-[9rem] rounded-[10px]">
            <div className="lg:flex gap-2 mt-2 lg:flex-row flex-col-reverse flex">
              <img
                src={chart2}
                className="w-[3.5rem] lg:w-[3rem] h-[4rem] lg:h-[2rem] lg:mt-3 ml-6 bg-slate-500"
              />
          ...
          <div className="bg-red-500 shadow-xl lg:w-[13rem] w-[6.6rem] lg:h-[5rem] h-[9rem] rounded-[10px]">
            <div className="lg:flex gap-2 mt-2 lg:flex-row flex-col-reverse flex">
              <img
                src={chart3}
                className="w-[3.5rem] lg:w-[3rem] h-[4rem] lg:h-[2rem] lg:mt-3 ml-6"
              />
              <div className="text-sm ml-6 mt-2 lg:ml-2">
        ...
        <div class="">
          <div class="absolute lg:-mt-[22rem] mt-[2rem] flex lg:hidden sm:gap-[13rem] gap-[10rem] ml-6">
            ...
            <div class="">
              <select className="p-1 w-[5rem] rounded-xl h-[2rem] text-violet-800 bg-blue-100 lg:bg-white font-medium">
                <option>Year</option>
                <option>2024</option>
                <option>2023</option>
                <option>2022</option>
