    ...
    <div>
        <div>
            <div class="flex justify-around gap-[7rem] mt-10">
                ...
                <div class="bg-red-500 w-[2rem] flex justify-center h-[2rem] rounded-lg" ><FaPlus style={iconStyle}/></div>
            </div>

            <div class="mt-5">
                <div class="flex gap-3 ml-3 mt-5">
                    <div class="bg-white w-[3rem] flex justify-center h-[2.7rem] rounded-lg ml-2"><FaTaxi style={iconStyle1}/></div>
                ...
                <div class="flex gap-3 ml-3 mt-7">
                    <div class="bg-white w-[3rem] flex justify-center h-[2.7rem] rounded-lg ml-2"><FaShoppingBag style={iconStyle1}/></div>
                ...
                <div class="flex gap-3 ml-3 mt-7">
                    <div class="bg-white w-[3rem] flex justify-center h-[2.7rem] rounded-lg ml-2"><img src={neflix} style={iconStyle2}/></div>
                    <div class="flex gap-[7rem]">
                        <div>
